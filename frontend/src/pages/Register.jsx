...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    axios.post("http://localhost:3000/users/", registered).then((response) => {
  ...
  return (
    <>
      ...
      <Container>
        <Wrapper>
          <HeroTitle>Sign up to play game</HeroTitle>
          <Title>Register to create and manage online tests, quizzes and assessments with RAJ.</Title>
          <FormWrapper>
